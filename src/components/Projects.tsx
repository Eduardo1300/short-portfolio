...
const ProjectCard: React.FC<{ 
  ...
  <div className="glass-card glass-card-hover rounded-2xl overflow-hidden animate-fade-in-up">
    <div className="project-image h-32 sm:h-48 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
      <div className="text-4xl sm:text-6xl text-cyan-400">
        {icon}
      </div>
    </div>
    <div className="p-4 sm:p-6">
      <h3 className="text-lg sm:text-2xl font-bold text-cyan-400 mb-2">{title}</h3>
