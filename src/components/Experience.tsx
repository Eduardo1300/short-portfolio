          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-4 mb-2">
                <h3 className="text-lg sm:text-xl font-semibold text-cyan-400" itemProp="roleName">{exp.title}</h3>
                {isCurrent && (
                  <span className="text-xs font-bold px-3 py-1 rounded-full bg-cyan-400/20 text-cyan-300 whitespace-nowrap" title="Current position">
